        ...
        <div>
            ...
            <div class="homeImage animate__fadeInLeft">
                ...
                <div class="font hidden md:block lg:block xl:block text-3xl z-10 py-64" style="height: 70%">
                    <div class="text-2xl uppercase text-black flex justify-center items-center mt-2" style="color: #000"><span style="color: #f9b629" class="mx-3"> the </span> <span style="color: #fff">best online</span> <span style="color: #f9b629" class="mx-3"> education </span> in the world</div>
