        ...
        <div>
            ...
            <div class="homeImage animate__fadeInLeft">
                <div class="colortext font hidden md:block lg:block xl:block text-3xl py-64 w-full" style="height: 70%">
                    <div data-aos="fade-up" data-aos-offset="300" data-aos-easing="ease-in-sine" class="text-xl uppercase text-black flex justify-center items-center lg:mt-12 xl:mt-12" style="color: #fff">the best online education <span style="color: #000" class="mx-3">in the world</span></div>
                    <div data-aos="fade-up" data-aos-offset="300" data-aos-easing="ease-in-sine" class="text-5xl uppercase text-black flex justify-center items-center font-bold mt-3" style="color: #000">one <span style="color: #000" class="mx-3"> steps </span> ahead this season</div>
