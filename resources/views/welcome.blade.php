                ...
                <div class="colortext font hidden md:block lg:block xl:block text-3xl py-64 w-full" style="height: 70%">
                    ...
                    <div class="flex justify-center mt-8">
                        ...
                        <a href="/contact" style="color: #f9b629; text-decoration: none">
                            <div class="hover:shadow-2xl transition duration-700 ease-in-out text-base uppercase mx-2 h-12 w-40 flex justify-center items-center rounded" style="background: #000; ">Contact Us</div>
                        </a>
                    </div>
                </div>
