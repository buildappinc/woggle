            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                   ...
                   @foreach ($inactiveNotification as $item)
                    <div class="w-full h-12 bg-gray-800 rounded flex justify-between items-center my-3 p-2 text-white">
                        <div>{{$item->data}}</div>
                        <a href="" class="text-black">
                            <div class="text-center capitalize rounded p-2" style="font-size: 0.82rem; color:#fff; background: #f7b728; cursor: pointer">Mark as unread</div>
                        </a>
                    </div> 
                   @endforeach
                </div>
                ...
                <div class="h-auto shadow-md rounded-lg border border-grap-100 p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6 p-3">
                        @foreach ($courses as $item)
                            ...
                            <a class="text-black" href="/admin/courses/{{$item->id}}/edit">
                                <div class="w-full h-64 bg-gray-200 relative" style=" -webkit-box-shadow: -1px 7px 40px -28px rgba(61,10,10,1); -moz-box-shadow: -1px 7px 40px -28px rgba(61,10,10,1); box-shadow: -1px 7px 40px -28px rgba(61,10,10,1);">
                                    <div class="h-full">
